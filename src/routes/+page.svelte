<script lang="ts">
    ...
    LayoutPropsState.bodyClass = "antialiased selection:bg-[var(--hub-primary)] selection:text-white";
...
<main>
    ...
    <section class="px-6 md:px-12 -mt-6 relative z-20">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            <!-- Dashboard / Overview -->
            <!-- <a class="opacity-40 bg-[var(--hub-card-bg)] border border-[var(--hub-outline)] p-6 rounded-2xl hover:border-[var(--hub-primary)]/50 transition-all group" href="#"> -->
            <a class="opacity-40 bg-[var(--hub-card-bg)] border border-[var(--hub-outline)] p-6 rounded-2xl transition-all group cursor-auto" href="#">
            ...
            <!-- Vanilla Chapters -->
            <!-- <a class="opacity-40 bg-[var(--hub-card-bg)] border border-[var(--hub-outline)] p-6 rounded-2xl hover:border-[var(--hub-secondary)]/50 transition-all group" href="#"> -->
            <a class="opacity-40 bg-[var(--hub-card-bg)] border border-[var(--hub-outline)] p-6 rounded-2xl  transition-all group cursor-auto" href="#">
            ...
            <!-- Modded Content -->
            <!-- <a class="opacity-40 bg-[var(--hub-card-bg)] border border-[var(--hub-outline)] p-6 rounded-2xl hover:border-[var(--hub-tertiary)]/50 transition-all group" href="#"> -->
            <a class="opacity-40 bg-[var(--hub-card-bg)] border border-[var(--hub-outline)] p-6 rounded-2xl  transition-all group cursor-auto" href="#">
            ...
            <!-- CSR Roadmap -->
            <!-- <a class="opacity-40 bg-[var(--hub-card-bg)] border border-[var(--hub-outline)] p-6 rounded-2xl hover:border-purple-400/50 transition-all group" href="#"> -->
            <a class="opacity-40 bg-[var(--hub-card-bg)] border border-[var(--hub-outline)] p-6 rounded-2xl transition-all group cursor-auto" href="#">

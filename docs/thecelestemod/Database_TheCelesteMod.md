# Database Schema: Celeste Mod Reference (Read-Only)

**Status:** READ-ONLY | **Role:** Source of Truth for Mod-Side Data

This file represents the official schema used by the `TheCelesteTracker` Celeste mod. It is for reference only to ensure the Desktop application remains compatible with the data generated in-game.

### Usage:
- Do NOT modify this file.
- Use this as the base for all migrations in `Database_TheCelesteDesktop.md`.
